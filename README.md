...
* Master branch: Production version (copy of [fhem/fhem-mirror/blob/master/fhem/FHEM/98_GEOFANCY.pm](https://github.com/fhem/fhem-mirror/blob/master/fhem/FHEM/98_GEOFANCY.pm))
...
Identified bugs and feature requests are tracked using [Github Issues](https://github.com/fhem/GEOFANCY/issues).
